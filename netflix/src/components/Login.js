...
//                 <img className='w-[100vw] h-[100vh] bg-cover' src="https://wallpapers.com/images/high/netflix-background-gs7hjuwvv2g0e9fj.webp" alt="netflix-background" />
//             </div>
//             <form onSubmit={getInputData} className=' flex flex-col w-3/12 p-12 my-36 left-0 right-0 mx-auto items-center justify-center absolute bg-black rounded-md opacity-90'>
//                 <h1 className='text-3xl text-white mb-5 font-bold'>{isLogin ? "Login" : "SignUp"}</h1>
//                 <div className='flex flex-col'>
//                     {
//                         !isLogin && <input value={fullName} onChange={(e) => setFullName(e.target.value)} type='text' placeholder='FullName' className='outline-none p-3 my-2 rounded-small bg-gray-800 text-white' />
//                     }
//                     <input value={email} onChange={(e) => setEmail(e.target.value)} type='email' placeholder='Email' className='outline-none p-3 my-2 rounded-small bg-gray-800 text-white' />
//                     <input value={password} onChange={(e) => setPassword(e.target.value)} type='password' placeholder='Password' className='outline-none p-3 my-2 rounded-small bg-gray-800 text-white' />
